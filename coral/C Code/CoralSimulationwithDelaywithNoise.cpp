		...
		//	{
				...
				while (dt<=0.0001)
				{
					...
					if ((int)round(10000*tau)%(int)round(dt*10000)==0)
					{
						...
						{
							//y[0]=coralSaddle; //initial Macroalgae level
							//z[0]=macroSaddle; //initial Coral level
							//v[0]=coralSaddle;
							//w[0]=macroSaddle;
							y[0]=.33; //initial Macroalgae level
							z[0]=.44; //initial Coral level
							v[0]=.33;
							w[0]=.44;
							...
							linear(steps,a,gamma,r,d,g,x,y,z,dt,n,beta,tau,fp,k,coralSaddle,macroSaddle,v,w);
						}
					}
					dt=dt+0.0001;
		//		}
